...
public class AdministratorsDAO extends BaseHibernateDAO {
	...
	public Administrators findById(java.lang.String id) {
		...
		try {
			Administrators instance = (Administrators) getSession().get("com.tjcsims.entity.Administrators", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Administrators instance) {
		...
		try {
			List results = getSession().createCriteria("com.tjcsims.entity.Administrators")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Administrators instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Administrators as model where model." + propertyName + "= ?";
	...
	public Administrators merge(Administrators detachedInstance) {
		...
		try {
			Administrators result = (Administrators) getSession().merge(detachedInstance);
