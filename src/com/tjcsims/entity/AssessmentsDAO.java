...
/**
 	* A data access object (DAO) providing persistence and search support for Assessments entities.
...
public class AssessmentsDAO extends BaseHibernateDAO  {
    ...
    public Assessments findById( java.lang.Integer id) {
        ...
        try {
            Assessments instance = (Assessments) getSession()
                    .get("com.tjcsims.entity.Assessments", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Assessments instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.tjcsims.entity.Assessments")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Assessments instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from Assessments as model where model." 
         						+ propertyName + "= ?";
    ...
    public Assessments merge(Assessments detachedInstance) {
        ...
        try {
            Assessments result = (Assessments) getSession()
