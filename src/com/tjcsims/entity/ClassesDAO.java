 ...
 * 
 * @see com.tjcsims.entity.Classes
...
public class ClassesDAO extends BaseHibernateDAO {
	...
	public Classes findById(java.lang.Integer id) {
		...
		try {
			Classes instance = (Classes) getSession().get("com.tjcsims.entity.Classes", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Classes instance) {
		...
		try {
			List results = getSession().createCriteria("com.tjcsims.entity.Classes").add(Example.create(instance))
					.list();
