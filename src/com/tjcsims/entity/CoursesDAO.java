...
/**
 	* A data access object (DAO) providing persistence and search support for Courses entities.
...
public class CoursesDAO extends BaseHibernateDAO  {
    ...
    public Courses findById( java.lang.Integer id) {
        ...
        try {
            Courses instance = (Courses) getSession()
                    .get("com.tjcsims.entity.Courses", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Courses instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.tjcsims.entity.Courses")
    ...
    public Courses merge(Courses detachedInstance) {
        ...
        try {
            Courses result = (Courses) getSession()
