...
/**
 	* A data access object (DAO) providing persistence and search support for Majors entities.
...
public class MajorsDAO extends BaseHibernateDAO  {
    ...
    public Majors findById( java.lang.Integer id) {
        ...
        try {
            Majors instance = (Majors) getSession()
                    .get("com.tjcsims.entity.Majors", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Majors instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.tjcsims.entity.Majors")
    ...
    public Majors merge(Majors detachedInstance) {
        ...
        try {
            Majors result = (Majors) getSession()
