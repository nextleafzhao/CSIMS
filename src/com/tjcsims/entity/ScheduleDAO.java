...
public class ScheduleDAO extends BaseHibernateDAO {
	...
	public Schedule findById(java.lang.Integer id) {
		...
		try {
			Schedule instance = (Schedule) getSession().get("com.tjcsims.entity.Schedule", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Schedule instance) {
		...
		try {
			List results = getSession().createCriteria("com.tjcsims.entity.Schedule").add(Example.create(instance))
					.list();
