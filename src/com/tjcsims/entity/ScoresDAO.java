...
/**
 	* A data access object (DAO) providing persistence and search support for Scores entities.
...
public class ScoresDAO extends BaseHibernateDAO  {
    ...
    public Scores findById( java.lang.Integer id) {
        ...
        try {
            Scores instance = (Scores) getSession()
                    .get("com.tjcsims.entity.Scores", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Scores instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.tjcsims.entity.Scores")
    ...
    public Scores merge(Scores detachedInstance) {
        ...
        try {
            Scores result = (Scores) getSession()
