...
public class StudentsDAO extends BaseHibernateDAO {
	...
	public Students findById(java.lang.Integer id) {
		...
		try {
			Students instance = (Students) getSession().get("com.tjcsims.entity.Students", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Students instance) {
		...
		try {
			List results = getSession().createCriteria("com.tjcsims.entity.Students").add(Example.create(instance))
					.list();
